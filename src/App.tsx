...
const users = [
    {id: 1, name: "Jake", email: "j.jackson@example.com"},
    {id: 2, name: "Jenny", email: "j.jenkins@example.com"},
    {id: 3, name: "Jose", email: "j.jobson@example.com"},
    {id: 4, name: "Jill", email: "j.jamesone@example.com"},
    {id: 5, name: "John", email: "j.jefferson@example.com"},
    {id: 6, name: "Jacob", email: "j.jones@example.com"},
    {id: 7, name: "Jade", email: "j.jennings@example.com"},
];
...
function SortableItem({user}: { user: User }) {
    ...
    return (
        <Table.Row ref={setNodeRef} style={style} className='bg-white relative'>
            ...
            <Table.Cell ref={setActivatorNodeRef} {...listeners} {...attributes} className='w-[60px] hover:text-slate-800'>
                <svg
